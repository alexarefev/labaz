CREATE FUNCTION public.dbcreation_test_wo_user() RETURNS integer
    LANGUAGE plpgsql
    AS $$
DECLARE
...
BEGIN
    ...
    SELECT 'unit_test_db', '', 'unit_test_host', 'test_type1' INTO database_name, user_name, host, db_type;
    RAISE NOTICE 'TEST: Without user_name';
