CREATE FUNCTION public.dbcreation_test_wo_type() RETURNS integer
    LANGUAGE plpgsql
    AS $$
DECLARE
...
BEGIN
    ...
    SELECT 'unit_test_db', 'unit_test_user', 'unit_test_host', '' INTO database_name, user_name, host, db_type;
    RAISE NOTICE 'TEST: Without type';
